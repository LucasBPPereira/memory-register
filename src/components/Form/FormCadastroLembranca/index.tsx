...
const lembrancaRegisterSchema = z.object({
  ...
  description: z.string().min(10, {
    message: "A descrição precisa de no mínimo 10 caracteres.",
  }),
...
export default function CriarLembrança() {
  ...
  const handlerOnSubmit = async (data: LembrancaRegisterSchema) => {
    ...
    try {
      ...
      toast({
        ...
        description: `Lembrança do dia ${form.getValues(
          "dateLembranca"
        )} criada!`,
      });
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Isso vai ajudar a encontrar na sua lista
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Selecione a data da qual você deseja lembrar futuramente
                    </FormDescription>
                  </FormItem>
                )}
              />
